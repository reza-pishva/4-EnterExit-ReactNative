...
import HiddenActionManeger13 from './HiddenActionManeger13';
import { SwipeListView } from 'react-native-swipe-list-view';
import { useFonts } from 'expo-font';
import Header13 from './Header16';
import { useNavigation } from '@react-navigation/native';
import { useIsFocused } from "@react-navigation/native";
import ActivityIndicator from '../../components/ActivityIndicator2';

function NotConfirmedByModir({route}) {
  ...
  const [loaded] = useFonts({
    ...
    <Screen>
      ...
      <SwipeListView
                ...
                />}
                renderHiddenItem={(listing)=><HiddenActionManeger13 data2={listing}/>}
                rightOpenValue={-135}
                previewRowKey={'0'}
                previewOpenValue={-40}
...
export default NotConfirmedByModir;