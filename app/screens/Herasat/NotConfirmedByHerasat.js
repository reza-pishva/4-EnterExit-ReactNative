...
import HiddenActionManeger14 from './HiddenActionManeger14';
...
function NotConfirmedByHerasat({route}) {
  ...
  const [loaded] = useFonts({
    ...
    <Screen>
      ...
      <SwipeListView
                ...
                />}
                renderHiddenItem={(listing)=><HiddenActionManeger14 data2={listing}/>}
                rightOpenValue={-135}
                previewRowKey={'0'}
                previewOpenValue={-40}
...
export default NotConfirmedByHerasat;