...
import HiddenActionManeger12 from './HiddenActionManeger12';
...
function ConfirmedByHerasat({route}) {
    ...
    <Screen>
      <Header15/>
      {
        ...
        <SwipeListView
                ...
                />}
                renderHiddenItem={(listing)=><HiddenActionManeger12 data2={listing}/>}
                rightOpenValue={-135}
                previewRowKey={'0'}
                previewOpenValue={-40}
...
export default ConfirmedByHerasat;