...
function HiddenActionManeger14({data2}) {
    
  const navigation=useNavigation();
    return (
    <View style={styles.container}>
        <TouchableOpacity style={styles.opa} onPress={()=>navigation.navigate("returnToKartableForHerasat",
        ...
        <TouchableOpacity style={styles.opa} onPress={()=>navigation.navigate("requestdetails4",
        {id_exit:data2.item.id_exit.toString()
        ,description:data2.item.description
        ,date_request_shamsi:data2.item.date_request_shamsi
        ,id_form:data2.item.id_form
...
export default HiddenActionManeger14;