...
import HiddenActionManeger11 from './HiddenActionManeger11';
...
function NewRequestForHerasat({route}) {
  ...
  const [loaded] = useFonts({
    ...
    <Screen>
      ...
      <SwipeListView
                ...
                />}
                renderHiddenItem={(listing)=><HiddenActionManeger11 data2={listing}/>}
                rightOpenValue={-200}
                previewRowKey={'0'}
                previewOpenValue={-40}
...
export default NewRequestForHerasat;