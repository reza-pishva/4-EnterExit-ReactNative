...
import HiddenActionManeger2 from './HiddenActionManeger2';
...
function NewRequestForGaurds({route}) {
  ...
  const [loaded] = useFonts({
    ...
    <Screen>
      ...
      <SwipeListView
                ...
                />}
                renderHiddenItem={(listing)=><HiddenActionManeger2 data2={listing}/>}
                rightOpenValue={-135}
                previewRowKey={'0'}
                previewOpenValue={-40}
...
export default NewRequestForGaurds;