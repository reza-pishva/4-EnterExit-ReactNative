...
import HiddenActionManeger18 from './HiddenActionManeger18';
...
function NotConfirmedByHerasat2Pe({route}) {
  ...
  const [loaded] = useFonts({
    ...
    <Screen>
      ...
      />}
       renderHiddenItem={(listing)=><HiddenActionManeger18 data2={listing}/>}
       rightOpenValue={-130}
       previewRowKey={'0'}
       previewOpenValue={-40}
...
export default NotConfirmedByHerasat2Pe;