...
function ReturnToKartableForModirPe({route}) {
  var day=0;
  var month=0;
  var year=0;
 ...
 const handleconfirm = () => {
   const url='http://rezapishva.ir/mob-kartabl5-pe/'+route.params.id_ef;
  fetch(url,{
    method:'get',
    headers:{
...
export default ReturnToKartableForModirPe;