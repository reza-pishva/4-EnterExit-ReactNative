...
function Confirm4Pe({route}) {
  ...
  Alert.alert(
    "",
    "از تایید این درخواست اطمینان دارید؟",
    [
      {
        text: "خیر",
 ...
 const handleconfirm = () => {
   const url='http://rezapishva.ir/mob_confirm_req4_pe/'+route.params.id_ef;
  fetch(url,{
    method:'get',
    headers:{
      ...
      response.json().then(function(resp){
        Toast.show('این درخواست با موفقیت تایید گردید.', Toast.LONG);
        // console.log(resp)
      })
    })
}; 
      ...
      <Screen>
        ...
        <TouchableOpacity onPress={createTwoButtonAlert} style={styles.itemcontainer3}>
          <View style={{alignItems:'center',marginTop:-5}}>
            <Text style={{color:'white'}}>تایید درخواست</Text>
          </View>
        </TouchableOpacity>
        </ScrollView>
