...
function NotConfirm5Pe({route}) {
 ...
 const handleconfirm = () => {
   const url='http://rezapishva.ir/mob_notconfirm_req5_pe/'+route.params.id_ef+'/'+reason;
  fetch(url,{
    method:'get',
    headers:{
