...
function HiddenActionManeger18({data2}) {
  ...
  const navigation=useNavigation();
    ...
    <View style={styles.container}>
        <TouchableOpacity style={styles.opa} onPress={()=>navigation.navigate("returnToKatableForHerasat5Pe",
        ...
        <TouchableOpacity style={styles.opa} onPress={()=>navigation.navigate("requestdetails20Pe",
        {id_ef:data2.item.id_ef.toString(),
            title:data2.item.title,  
            company:data2.item.company,
            date_shamsi:data2.item.date_shamsi,
