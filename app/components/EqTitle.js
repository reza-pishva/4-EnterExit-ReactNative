    ...
    return (
      <Screen>
           <ImageBackground style={styles.container} source={require('../pic/bg23.jpg')}>
              <Image style={{borderRadius:60}} source={require('../pic/truck3.jpg')}/>
              <Text style={styles.text}>نرم افزار مدیریت ورود و خروج کالا و تجهیزات نیروگاهی</Text>
           </ImageBackground>
      </Screen>
