...
function ReportPageRequester(props) {
    return (
        <Screen>
          <ImageBackground style={styles.container1} source={require('../pic/bg21.jpg')}>
             <View style={styles.container2}>
                    <View style={styles.header}><Text style={{color:"white"}}>گردش درخواست - درخواست کننده</Text></View>
...
export default ReportPageRequester;