...
function ReportPageForFirstBoss(props) {
    return (
        <Screen>
          <ImageBackground style={styles.container1} source={require('../pic/bg19.jpg')}>
             <View style={styles.container2}>
                    <View style={styles.header}><Text style={{color:"white"}}>گردش درخواست - مسئول مستقیم</Text></View>
...
export default ReportPageForFirstBoss;